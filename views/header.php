    ...
    <div class="container-navigation">
        <div class="nav-bar">
            ...
            <div class="navigation">
                <ul class="menu">
                    <div class="uil uil-times nav-close-btn"></div>
                    <li class="menu-item"><a href="/views/home.php">Home</a></li>
                    <li class="menu-item">
                        <a class="sub-btn" href="#">Database <i class="fas fa-angle-down"></i></a>
                        <ul class="sub-menu">
                            <li class="sub-item"><a href="/views/category.php">Categories</a></li>
                            <li class="sub-item"><a href="/views/product.php">Product</a></li>
                        </ul>
                    </li>
                    <li class="menu-item">
                    ...
                    <li class="menu-item"><a href="/views/logout.php">Log out</a></li>
                </ul>
            </div>
